...
subroutine compute_boundary_eta
   ...
   ! jw
   ! jw
	u2_old = julian_day*86400.0_dp - dt ! jw
	u2_new = julian_day*86400.0_dp 		! jw
		...
		! jw
      	...
      	! jw
			do t2=2,eta_ser_data_num(eta_ser_id(i)) ! jw
				...
				! jw
				! jw
				u1 = eta_ser_time(t2-1,eta_ser_id(i)) - reference_diff_days * 86400.0_dp  		! jw
				u3 = eta_ser_time(t2  ,eta_ser_id(i)) - reference_diff_days * 86400.0_dp		! jw
