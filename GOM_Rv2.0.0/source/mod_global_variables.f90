...
!=============================================================================!
   ...
   integer, save :: tser_eta, tser_H, tser_u, tser_v, tser_salt, tser_temp, tser_airp
	...
	integer, save :: IS2D_buff = 0, IS2D_buff2 = 0 ! jw
	...
	character(len = 100), save :: IS3D_File_name_surf, IS3D_File_name_full
 	...
 	integer, save :: IS3D_buff = 0, IS3D_buff2 = 0 ! jw
	...
	real(dp),save :: IS2D_dump_time_conv 						! jw
 	...
 	integer, save :: IS2D_dump_buff = 0, IS2D_dump_buff2 = 0 ! jw
	...
	real(dp),save :: IS3D_dump_time_conv 						! jw
 	...
 	integer, save :: IS3D_dump_buff = 0, IS3D_dump_buff2 = 0 ! jw
	...
	integer, save :: netcdf_buff = 0, netcdf_buff2 = 0 ! jw
	integer, save :: netcdf_buff3 = 0 ! jw
	integer, save :: netcdf_maxtime ! jw
	
	! jw
	integer, save :: netcdf_variable_cell(6) = 0
	character(len=10), dimension(6) :: netcdf_variable_name_cell	! jw

	! jw
	integer, save :: netcdf_variable_node(15) = 0
	character(len=10), dimension(15) :: netcdf_variable_name_node	! jw

	! jw
	integer, save :: netcdf_variable_face(2) = 0
	character(len=10), dimension(2) :: netcdf_variable_name_face	! jw
