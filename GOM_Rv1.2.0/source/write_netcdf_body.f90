...
subroutine write_netcdf_body
	...
	! I must pass an array to netcdf even though it is a scalar number, and that is why I creating an array for each scalar number
	integer :: it_array(1), local_time_array(5)
	real(dp):: elapsed_time_hr_array(1), elapsed_time_day_array(1), julian_day_array(1)
	! End of local variables ==================================================!
	
	! write some fundamental information ======================================!
	! write time (identical format as in main.f90 (i.e., as in screen show):
	it_array(1) = it
	...
	! write top & bottom layer information:
