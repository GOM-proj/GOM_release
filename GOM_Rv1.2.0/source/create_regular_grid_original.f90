...
! 	x_node2 = x_node - xmin + 5*dx ! to create 5 left ghost cell
! 	y_node2 = y_node - ymin + 5*dy ! to create 5 bottom ghost cell
	
	! total number of grids in a new regular grid
	regular_grid_xi = int((xmax - xmin)/dx) + 1 + x_ghost_cell * 2 ! 5 left and 5 right ghost cells
	regular_grid_yi = int((ymax - ymin)/dy) + 1 + y_ghost_cell * 2 ! 5 left and 5 right ghost cells
