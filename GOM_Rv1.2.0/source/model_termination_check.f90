...
subroutine model_termination_check
	...
	! Find maximum/minimum values and locations ===============================!
	! Note all old variables have already updated with new values in "update_variables.f90",
	! and that is why I use old variables here.
	! (maxele)
	...
	! write an error message and terminate GOM ================================!
